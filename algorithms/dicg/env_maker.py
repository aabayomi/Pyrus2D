...
# from envs.predatorprey_wrapper import PredatorPreyWrapper2
# from envs.keepaway_wrapper import KeepawayWrapper
            ...
            [
                ...
                for item in [
                    ...
                    (
                        ...
                        if args.policy in ["proximal_cg", "adaptive"]
                        else None
                    ),
                    (
    ...
    if args.env == "traffic":
        ...
        if args.policy == "proximal_cg":
            try:
                args.proximity_threshold = float(
                    input(
                        ">>> [Press Enter for default value 1.5] proximity_threshold = "
                    )
                )
                print(
                    ">>> Setting proximity_threshold = {:.1f}".format(
        ...
        if args.policy == "proximal_cg":
            try:
                args.proximity_threshold = float(
                    input(
                        ">>> [Press Enter for default value 2.0] proximity_threshold = "
                    )
                )
                print(
                    ">>> Setting proximity_threshold = {:.1f}".format(
