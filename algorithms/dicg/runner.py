...
from torch_.algos import CentralizedMAPPO
from torch_.baselines import CentValueFunction
from sampler import CentralizedMAOnPolicySampler
...
def train():
    ...
    if args.load_path or args.continuing_checkpoint:
        ...
        if args.eval:
            ...
            # record_gym_video(
            #     env, args.video_save_path, n_episodes=5, policy=algo.policy
            # )
        exit()
    else:
