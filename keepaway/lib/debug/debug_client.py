...
class DebugClient:
    ...
    class Line:
        ...
        def to_str(self):
            s = (
                f"(line {self._segment.origin().x():.3f} "
    ...
    class Circle:
        ...
        def to_str(self):
            s = (
                f"(circle {self._circle.center().x():.3f} "
    ...
    def to_str(self, world: "WorldModel", effector):
        ...
        if world.self() and world.self().pos().is_valid():
            ostr_player = (
                ...
                + ' (c "'
                + str(world.self().pos_count())
                + " "
                + str(world.self().vel_count())
                + " "
                + str(world.self().face_count())
            )
        ...
        if world.ball().pos().is_valid():
            ...
            if world.ball().vel_valid():
                ostr_ball += (
                    " "
                    + str(round(world.ball().vel().x(), 2))
                    + " "
                    + str(round(world.ball().vel().y(), 2))
                )
            ostr_ball += (
                " (c 'g"
                + str(world.ball().pos_count())
                + "r"
                + str(world.ball().rpos_count())
                + "v"
