...
from keepaway.garage import log_performance, TrajectoryBatch
from keepaway.garage.misc import tensor_utils
from keepaway.garage.torch.algos import (_Default, compute_advantages, filter_valids,
                                make_optimizer, pad_to_last)
from keepaway.garage.torch.utils import flatten_batch
from keepaway.garage.np.baselines import LinearFeatureBaseline

from keepaway.dicg.np.algos import MABatchPolopt
from keepaway.dicg.torch.algos.utils import pad_one_to_last
...
class CentralizedMAPPO(MABatchPolopt):
    ...
    Args:
        env_spec (keepaway.garage.envs.EnvSpec): Environment specification.
        policy (keepaway.garage.torch.policies.base.Policy): Policy.
