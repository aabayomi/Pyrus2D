...
from keepaway.garage.torch.modules import GaussianMLPModule

class GaussianMLPBaseline(nn.Module):
    ...
    Args:
        env_spec (keepaway.garage.envs.env_spec.EnvSpec): Environment specification.
    ...
    def __init__(self,
        ...
        output_dim = 1 # V(s), value function
    ...
    def compute_loss(self, obs, returns):
        ...
        """
        dist = self.module(obs.reshape(-1, self.input_dim))
