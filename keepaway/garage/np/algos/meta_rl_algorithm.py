...
class MetaRLAlgorithm(RLAlgorithm, abc.ABC):
    ...
    def get_exploration_policy(self):
        ...
        Returns:
            keepaway.garage.Policy: The policy used to obtain samples that are later
    ...
    def adapt_policy(self, exploration_policy, exploration_trajectories):
        ...
        Args:
            exploration_policy (keepaway.garage.Policy): A policy which was returned
                ...
                method.
            exploration_trajectories (keepaway.garage.TrajectoryBatch): Trajectories to
                adapt to, generated by exploration_policy exploring the
                environment.

        Returns:
            keepaway.garage.Policy: A policy adapted to the task represented by the
