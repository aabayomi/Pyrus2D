...
from keepaway.garage.np.algos import RLAlgorithm
from keepaway.garage.sampler import OffPolicyVectorizedSampler
from keepaway.garage.sampler.utils import rollout
...
class OffPolicyRLAlgorithm(RLAlgorithm):
    ...
    Args:
        ...
        policy (keepaway.garage.tf.policies.base.Policy): Policy.
        qf (object): The q value network.
        replay_buffer (keepaway.garage.replay_buffer.ReplayBuffer): Replay buffer.
        ...
        exploration_strategy
            (keepaway.garage.np.exploration_strategies.ExplorationStrategy):
    ...
    def _obtain_evaluation_samples(self,
        ...
        Args:
            env (keepaway.garage.envs.keepaway.garageEnv): The environement used to obtain
                trajectories.
