...
from keepaway.garage.sampler import Worker
...
class TFWorkerClassWrapper:
    ...
    Args:
        wrapped_class (type): The class to wrap. Should be a subclass of
            keepaway.garage.sampler.Worker.
...
class TFWorkerWrapper(Worker):
    ...
    def agent(self):
        ...
        Returns:
            keepaway.garage.Policy: the worker's agent.
    ...
    def agent(self, agent):
        ...
        Args:
            agent (keepaway.garage.Policy): The agent.
    ...
    def rollout(self):
        ...
        Returns:
            keepaway.garage.TrajectoryBatch: Batch of sampled trajectories. May be
