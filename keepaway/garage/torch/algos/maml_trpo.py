...
from keepaway.garage.torch.algos import _Default, VPG
from keepaway.garage.torch.algos.maml import MAML
...
class MAMLTRPO(MAML):
    ...
    Args:
        env (keepaway.garage.envs.keepaway.garageEnv): A multi-task environment.
