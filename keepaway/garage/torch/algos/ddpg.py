...
from keepaway.garage.torch.utils import np_to_torch, torch_to_np
...
class DDPG(OffPolicyRLAlgorithm):
    ...
    Args:
        ...
        exploration_strategy (keepaway.garage.np.exploration_strategies.ExplorationStrategy): # noqa: E501
