...
from keepaway.garage.misc import tensor_utils
from keepaway.garage.sampler import OnPolicyVectorizedSampler
from keepaway.garage.tf.samplers import BatchSampler
from keepaway.garage.torch.algos import _Default, make_optimizer
from keepaway.garage.torch.optimizers import ConjugateGradientOptimizer
from keepaway.garage.torch.optimizers import DifferentiableSGD
from keepaway.garage.torch.utils import update_module_params
...
class MAML:
    ...
    Args:
        env (keepaway.garage.envs.keepaway.garageEnv): A gym environment.
        policy (keepaway.garage.torch.policies.Policy): Policy.
        baseline (keepaway.garage.np.baselines.Baseline): The baseline.
        ...
        inner_algo (keepaway.garage.torch.algos.VPG): The inner algorithm used for
            computing loss.
    ...
    def policy(self):
        ...
        Returns:
            keepaway.garage.torch.policies.Policy: Current policy of the inner
                algorithm.
    ...
    def _old_policy(self):
        ...
        Returns:
            keepaway.garage.torch.policies.Policy: Old policy of the inner algorithm.
