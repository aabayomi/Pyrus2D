...
from keepaway.garage.experiment import deterministic
...
from keepaway.garage.sampler.utils import truncate_paths
...
class RL2Sampler(BaseSampler):
    ...
    Args:
        ...
        env (keepaway.garage.envs.keepaway.garageEnv): Environement to sample from.
