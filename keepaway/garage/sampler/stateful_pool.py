...
class StatefulPool:
    ...
    def run_each(self, runner, args_list=None):
        ...
        assert not inspect.ismethod(runner), (
            ...
            'object of type keepaway.garage.sampler.stateful_pool.SharedGlobal')
    ...
    def run_map(self, runner, args_list):
        assert not inspect.ismethod(runner), (
            ...
            'an object of type keepaway.garage.sampler.stateful_pool.SharedGlobal')
    ...
    def run_imap_unordered(self, runner, args_list):
        assert not inspect.ismethod(runner), (
            ...
            'keepaway.garage.sampler.stateful_pool.SharedGlobal')
