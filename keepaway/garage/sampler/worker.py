...
from keepaway.garage.sampler.env_update import EnvUpdate
...
class DefaultWorker(Worker):
    ...
    def update_agent(self, agent_update):
        """Update an agent, assuming it implements keepaway.garage.Policy.

        Args:
            agent_update (np.ndarray or dict or keepaway.garage.Policy): If a
    ...
    def collect_rollout(self):
        ...
        Returns:
            keepaway.garage.TrajectoryBatch: A batch of the trajectories completed since
    ...
    def rollout(self):
        ...
        Returns:
            keepaway.garage.TrajectoryBatch: The collected trajectory.
