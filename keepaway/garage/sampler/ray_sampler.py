...
from keepaway.garage import TrajectoryBatch
...
class RaySampler(Sampler):
    ...
    Args:
        worker_factory(keepaway.garage.sampler.WorkerFactory): Used for worker behavior.
        agents(list[keepaway.garage.Policy]): Agents to distribute across workers.
...
class SamplerWorker:
    ...
    def rollout(self):
        ...
        Returns:
            tuple[int, keepaway.garage.TrajectoryBatch]: Worker ID and batch of samples.
