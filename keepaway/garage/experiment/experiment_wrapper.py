...
import keepaway.garage.experiment
import keepaway.garage.plotter
import keepaway.garage.tf.plotter
...
def run_experiment(argv):
    ...
    if args.seed is not None:
        keepaway.garage.experiment.deterministic.set_seed(args.seed)
    ...
    if args.variant_data is not None:
        ...
        keepaway.garage.experiment.experiment.dump_json(variant_log_file, variant_data)
    else:
        variant_data = None
    ...
    snapshot_config = \
        keepaway.garage.experiment.SnapshotConfig(snapshot_dir=log_dir,
    ...
    try:
        ...
        children = keepaway.garage.plotter.Plotter.get_plotters()
        children += keepaway.garage.tf.plotter.Plotter.get_plotters()
...
def child_proc_shutdown(children):
    ...
    Args:
        children (list[keepaway.garage.plotter.Plotter]): Instances of plotter to
            shutdown.
    ...
    if alive:
        ...
        error_msg += ('https://github.com/rlworkgroup/keepaway.garage/issues/120')
        print(error_msg)
...
def log_parameters(log_file, args):
    ...
    with open(log_file, 'w') as f:
        json.dump(log_params,
                  ...
                  indent=2,
                  sort_keys=True,
                  cls=keepaway.garage.experiment.experiment.LogEncoder)
    keepaway.garage.experiment.experiment.dump_json(log_file, log_params)
