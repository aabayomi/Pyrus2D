...
from keepaway.garage.sampler import LocalSampler
...
class MetaEvaluator:
    ...
    Args:
        runner (keepaway.garage.experiment.LocalRunner): A runner capable of running
        ...
        test_task_sampler (keepaway.garage.experiment.TaskSampler): Sampler for test
    ...
    def evaluate(self, algo):
        ...
        Args:
            algo (keepaway.garage.np.algos.MetaRLAlgorithm): The algorithm to evaluate.
